...
public class CodePropertyGraph {
     ...
     * @throws GraftRuntimeException if the graph does not contain a CPG
     */
    ...
    public void close() {
        if (g instanceof Neo4jGraph) {
            try {
                ...
                throw new GraftRuntimeException("Unable to close Neo4j graph", e);
            }
        }
    }
     ...
     * @throws GraftRuntimeException if the file does not contain a CPG
     */
     ...
     * @throws GraftRuntimeException if the graph database does not contain a CPG
     */
